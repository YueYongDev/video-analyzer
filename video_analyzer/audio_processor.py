...
class AudioProcessor:
    def __init__(self,
        ...
        try:
            ...
            logger.info(
                f"Initiation Input: Model size or path: {model_size_or_path}, Device: {device}, Compute type: {compute_type}, Language: {self.language if self.language else 'auto detected'}")
